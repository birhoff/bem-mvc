modules.define('model', ['inherit', 'objects'], function(provide, inherit, objects, MODEL) {
    ...
    MODEL.FIELD.types['collection'] = inherit(MODEL.FIELD, {
        ...
        /**
         * Создает значение поля типа collection, которое предоставляет методы для работы со списком
        ...
        _createValueObject: function(field) {
            var list = {
                ...
                add: function(itemData, opts) {
                    ...
                    field
                        .emit('add', objects.extend({}, opts, { model: model }))
                ...
                remove: function(id, opts) {
                    ...
                    if (index !== undefined) {
                        ...
                        field.emit('remove', objects.extend({}, opts, { model: model }));
                        model.destruct();
